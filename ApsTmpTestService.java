...
import net.synergy2.db.aps.opr.AngApsShpOrdIcoImpl.AngApsShpOrdIcoFields;
...
import net.synergy2.db.sys.bas.AngCusImpl.AngCusFields;
...
import net.synergy2.db.sys.job.AngJobImpl.AngJobFields;
import net.synergy2.db.sys.job.AngSubJobImpl.AngSubJobFields;
import net.synergy2.db.sys.lgs.AngWhsImpl.AngWhsFields;
import net.synergy2.db.sys.org.OrgLvlImpl.OrgLvlFields;
import net.synergy2.db.sys.res.AngRes;
import net.synergy2.db.sys.res.AngResImpl.AngResFields;
import net.synergy2.db.sys.res.AngResTypImpl.AngResTypFields;
...
public class ApsTmpTestService {
    ...
    public AngItm post (AngItm item) {
        return rest.post (baseUrl + "/AngItm", item, AngItm.class);
    } // post

    public AngItm put (AngItm item) {
        return rest.put (baseUrl + "/AngItm", item, AngItm.class);
    } // put
    ...
    public AngItmVrn post (AngItmVrn item) {
        return rest.post(baseUrl + "/AngItmVrn", item, AngItmVrn.class);
    } // post
    
    public AngItmVrn put (AngItmVrn item) {
        return rest.put(baseUrl + "/AngItmVrn", item, AngItmVrn.class);
    } // put
    ...
    public AngPrdCyc post (AngPrdCyc item) {
        return rest.post(baseUrl + "/AngPrdCyc", item, AngPrdCyc.class);
    } // post
    
    public AngPrdCyc put (AngPrdCyc item) {
        return rest.put(baseUrl + "/AngPrdCyc", item, AngPrdCyc.class);
    } // put
    ...
    public AngPrdCycOpr post (AngPrdCycOpr item) {
        return rest.post(baseUrl + "/AngPrdCycOpr", item, AngPrdCycOpr.class);
    } // post
    
    public AngPrdCycOpr put (AngPrdCycOpr item) {
        return rest.put(baseUrl + "/AngPrdCycOpr", item, AngPrdCycOpr.class);
    } // put
    ...
    public AngPrdCycOprLnk post (AngPrdCycOprLnk item) {
        return rest.post(baseUrl + "/AngPrdCycOprLnk", item, AngPrdCycOprLnk.class);
    } // post
    
    public AngPrdCycOprLnk put (AngPrdCycOprLnk item) {
        return rest.put(baseUrl + "/AngPrdCycOprLnk", item, AngPrdCycOprLnk.class);
    } // put
    ...
    public AngItmMdl post (AngItmMdl item) {
        return rest.post(baseUrl + "/AngItmMdl", item, AngItmMdl.class);
    } // post
    
    public AngItmMdl put (AngItmMdl item) {
        return rest.put(baseUrl + "/AngItmMdl", item, AngItmMdl.class);
    } // put
    ...
    public AngItmMdlVrn post (AngItmMdlVrn item) {
        return rest.post(baseUrl + "/AngItmMdlVrn", item, AngItmMdlVrn.class);
    } // post
    
    public AngItmMdlVrn put (AngItmMdlVrn item) {
        return rest.put(baseUrl + "/AngItmMdlVrn", item, AngItmMdlVrn.class);
    } // put
    ...
    public List<AngBom> getActiveAngBom () {
        return rest.graphQueryGetMany (
            ...
            .join (
                Join.with (SAlias.AngBom_FKI_ItmVrn).filter (Filter.eq(AngItmVrnFields.LogDel, false))
                .join(Join.with(SAlias.AngItmVrn_FKI_Itm).filter (Filter.eq(AngItmFields.LogDel, false)))
                .join(
                    Join.with(SAlias.AngItmVrn_FKI_Vrn).filter (Filter.eq(AngPrdVrnFields.LogDel, false))
                        .join(Join.with(SAlias.AngPrdVrn_FKI_Cat).filter (Filter.eq(AngPrdVrnCatFields.LogDel, false)))
    ...
    public AngBom post (AngBom item) {
        return rest.post(baseUrl + "/AngBom", item, AngBom.class);
    } // post
    
    public AngBom put (AngBom item) {
        return rest.put(baseUrl + "/AngBom", item, AngBom.class);
    } // put
    ...
    public AngUniMea post (AngUniMea item) {
        return rest.post(baseUrl + "/AngUniMea", item, AngUniMea.class);
    } // post
    
    public AngUniMea put (AngUniMea item) {
        return rest.put(baseUrl + "/AngUniMea", item, AngUniMea.class);
    } // put
    ...
    public AngPrdVrnCat post (AngPrdVrnCat item) {
        return rest.post (baseUrl + "/AngPrdVrnCat", item, AngPrdVrnCat.class);
    } // post

    public AngPrdVrnCat put (AngPrdVrnCat entity) {
        return rest.put (baseUrl + "/AngPrdVrnCat", entity, AngPrdVrnCat.class);
    } // put
    ...
    public AngPrdVrn post (AngPrdVrn item) {
        return rest.post(baseUrl + "/AngPrdVrn", item, AngPrdVrn.class);
    } // post
    
    public AngPrdVrn put (AngPrdVrn item) {
        return rest.put(baseUrl + "/AngPrdVrn", item, AngPrdVrn.class);
    } // put
    ...
    public AngSup post (AngSup item) {
        return rest.post(baseUrl + "/AngSup", item, AngSup.class);
    } // post
    
    public AngSup put (AngSup item) {
        return rest.put(baseUrl + "/AngSup", item, AngSup.class);
    } // put
    ...
    /************************************************************************************/
     ...
     public List<AngRes> getActiveAngRes () {
         return rest.graphQueryGetMany (
             ...
             .join(Join.with(SAlias.AngRes_FKI_Typ).filter (Filter.eq(AngResTypFields.LogDel, false)))
     ...
     public List<AngResGrp> getActiveAngResGrp () {
         return rest.graphQueryGetMany (
             ...
             .join (Join.with(SAlias.AngResGrp_FKI_Res).mustExist (true))
             .filter (Filter.and (
//               Filter.eq (AngResGrpFields.LogDel, false),
               Filter.eq (AngGrpFields.LogDel, false),
               Filter.eq (AngResFields.LogDel, false)
           )));
     } // getActiveAngResGrp
    ...
    public List<ApsShpOrd> getActiveApsShpOrd() {
        return rest.graphQueryGetMany(
            ApsShpOrd.class,
            SGraphQuery.from(SAlias.ApsShpOrd)
                .join(Join.with(SAlias.ApsShpOrd_FKI_Sce).mustExist(true))
                .join(Join.with(SAlias.ApsShpOrd_FKI_Itm).filter(Filter.eq(AngItmFields.LogDel, false)))
                .join(Join.with(SAlias.ApsShpOrd_FKI_OrgLvl).filter(Filter.eq(OrgLvlFields.LogDel, false)))
                .join(Join.with(SAlias.ApsShpOrd_FKI_Whs).filter(Filter.eq(AngWhsFields.LogDel, false)))
                .join(Join.with(SAlias.ApsShpOrd_FKI_Job).filter(Filter.eq(AngJobFields.LogDel, false)))
                .join(Join.with(SAlias.ApsShpOrd_FKI_SubJob).filter(Filter.eq(AngSubJobFields.LogDel, false)))
                .join(Join.with(SAlias.ApsShpOrd_FKI_Cus).filter(Filter.eq(AngCusFields.LogDel, false)))
                .join(Join.with(SAlias.ApsShpOrd_FKI_PrdCyc).filter(Filter.eq(AngPrdCycFields.LogDel, false)))
                .join(Join.with(SAlias.ApsShpOrd_FKI_Ico).filter(Filter.eq(AngApsShpOrdIcoFields.LogDel, false)))
                .join(Join.with(SAlias.ApsShpOrd_FKI_Mdl).filter(Filter.eq(AngItmMdlFields.LogDel, false)))
//                .filter(Filter.eq(ApsShpOrdFields.LogDel, false))
        );
    } // getActiveApsShpOrd

    public ApsShpOrd post (ApsShpOrd item) {
        return rest.post(baseUrl + "/ApsShpOrd", item, ApsShpOrd.class);
    } // post
    
    public ApsShpOrd put (ApsShpOrd item) {
        return rest.put(baseUrl + "/ApsShpOrd", item, ApsShpOrd.class);
    } // put

    public void checkEq (ApsShpOrd item1, ApsShpOrd item2) {
        Boolean areEqual = rest.post (baseUrl + "/ApsShpOrd/check", new FctEqualsInput<> (item1, item2), null, Boolean.class, FctEqualsInput.class);
        rest.checkEq (true, areEqual);
    } // checkEq
    ...
    public List<ApsItmCop> getActiveApsItmCop () {
        return rest.graphQueryGetMany (
            ApsItmCop.class, 
            SGraphQuery.from (SAlias.ApsItmCop)
            .join (Join.with(SAlias.ApsItmCop_FKI_Itm).mustExist (true))
            .join (Join.with(SAlias.ApsItmCop_FKI_ShpOrd).mustExist (true))
            .filter (Filter.and (
//                Filter.eq (ApsItmCopFields.LogDel, false),
                Filter.eq (AngItmFields.LogDel, false)
//                Filter.eq (ApsShpOrdFields.LogDel, false)
            )));
    } // getActiveApsItmCop

    public ApsItmCop post (ApsItmCop item) {
        return rest.post(baseUrl + "/ApsItmCop", item, ApsItmCop.class);
    } // post
    
    public ApsItmCop put (ApsItmCop item) {
        return rest.put(baseUrl + "/ApsItmCop", item, ApsItmCop.class);
    } // put

    public void checkEq (ApsItmCop item1, ApsItmCop item2) {
        Boolean areEqual = rest.post (baseUrl + "/ApsItmCop/check", new FctEqualsInput<> (item1, item2), null, Boolean.class, FctEqualsInput.class);
        rest.checkEq (true, areEqual);
    } // checkEq
...
//    /************************************************************************************/
//    
//    public List<ApsOpr> getActiveApsOpr () {
//        return rest.graphQueryGetMany (
//            ApsOpr.class, 
//            SGraphQuery.from (SAlias.ApsOpr)
//            .join (Join.with(SAlias.ApsOpr_FKI_ShpOrd).mustExist (true))
//            .join (Join.with(SAlias.ApsOpr_FKI_PrdCycOpr).mustExist (true))
//            .join (Join.with(SAlias.ApsOpr_FKI_PlnGrp).mustExist (true))
//            .join (Join.with(SAlias.ApsOpr_FKI_SchRes).mustExist (true))
//            .join (Join.with(SAlias.ApsOpr_FKI_UniMea).mustExist (true))
//            .join (Join.with(SAlias.ApsOpr_FKI_AggOpr).mustExist (true))
//            .join (Join.with(SAlias.ApsOpr_FKI_Clr).mustExist (true))
//            .join (Join.with(SAlias.ApsOpr_FKI_MulPalOpr).mustExist (true))
//            
//            .filter (Filter.and (
////                Filter.eq (ApsItmCopFields.LogDel, false),
//                Filter.eq (AngItmFields.LogDel, false)
...
//    } // getActiveApsOpr
//
//    public ApsOpr post (ApsOpr item) {
//        return rest.post(baseUrl + "/ApsOpr", item, ApsOpr.class);
//    } // post
//    
//    public ApsOpr put (ApsOpr item) {
//        return rest.put(baseUrl + "/ApsOpr", item, ApsOpr.class);
//    } // put
//
//    public void checkEq (ApsOpr item1, ApsOpr item2) {
//        Boolean areEqual = rest.post (baseUrl + "/ApsOpr/check", new FctEqualsInput<> (item1, item2), null, Boolean.class, FctEqualsInput.class);
//        rest.checkEq (true, areEqual);
//    } // checkEq
