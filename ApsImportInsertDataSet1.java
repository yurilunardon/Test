...
//    } // if
    ...
    private void run2 () {
        ...
        AngPrdCycOpr T1emptyPrdCycOpr1 = sysItm.cycleOperation (T1emptyPrdCyc, null, "1", "T1emptyPrdCycOpr1").setPrdCyc (T1emptyPrdCyc.getCopy ().setItm (T1emptyItem)).setOprNum ("1");
        AngPrdCycOpr T1emptyPrdCycOpr2 = sysItm.cycleOperation (T1emptyPrdCyc, null, "2", "T1emptyPrdCycOpr2").setPrdCyc (T1emptyPrdCyc.getCopy ().setItm (T1emptyItem)).setOprNum ("2");
//        AngPrdCycOprLnk T1emptyPrdCycOprLnk = sysItm.cycleOperationLink (T1emptyPrdCycOpr1, T1emptyPrdCycOpr2).setPrePrdCycOpr (T1emptyPrdCycOpr1).setNxtPrdCycOpr (T1emptyPrdCycOpr2);
...
//        T1bom = apsTmp.post (T1emptyBom);
    ...
    private void run3 () {
        ...
        // AngPrdCycOpr
        T2prdCycOpr = sysItm.post (sysItm.cycleOperation (T2prdCyc, null, "1", "T2prdCycOpr").setPrdCyc (T2prdCyc.getCopy ().setItm (T2itm)).setOprNum ("1"));
        T2prdCycOpr2 = sysItm.post (sysItm.cycleOperation (T2prdCyc, null, "2", "T2prdCycOpr2").setPrdCyc (T2prdCyc.getCopy ().setItm (T2itm)).setOprNum ("2"));
        ...
        // AngPrdCycOpr
        T2prdCycOprTMP = apsTmp.post (sysItm.cycleOperation (T2prdCyc, null, "1", "T2prdCycOprTMP").setPrdCyc (T2prdCyc.getCopy ().setItm (T2itm)));
    ...
    private void checkRun2 () {
         ...
         AngPrdCycOpr dummyPrdCycOpr1 = AngPrdCycOpr.newInstance ().setPrdCyc (dummyPrdCyc.getCopy ().setItm (dummyItm)).setOprNum ("1");
         AngPrdCycOpr dummyPrdCycOpr2 = AngPrdCycOpr.newInstance ().setPrdCyc (dummyPrdCyc.getCopy ().setItm (dummyItm)).setOprNum ("2");
...
//          T1prdCycOprLnk.setPrePrdCycOpr (dummyPrdCycOpr1);
//          T1prdCycOprLnk.setPrePrdCycOpr (dummyPrdCycOpr2);
//          
...
//             T1bom.setPrdItm (dummyItm);
//             T1bom.setItm (dummyItm2);
...
//          
    ...
    private void checkRun3() {
        ...
        System.out.println (T2apsPrdCyc);
        System.out.println (T2prdCycTMP);
        ...
        System.out.println (T2apsPrdCycOpr);
        System.out.println (T2prdCycOprTMP);
