...
public class TmpField<V, E> {
    ...
    public TmpField<V, E> setCode (boolean isCode) { this.isCode = isCode; return this; } // setCodeGetter
    ...
    public boolean isValueEqualByCode (E entity1, E entity2) { 
        ...
        var cmp = comparatorByCode == null ? comparator : comparatorByCode;
    ...
    public void applySqlValueSetter (PreparedStatement stm, int index, E entity) throws SQLException {
    ...
    public interface ApsErpFieldSqlSetter<E> {
        public void setValue (PreparedStatement stm, int index, E entity) throws SQLException;
