...
public class T0002_importUpdate_V1 extends RestTest {
    ...
    @Override protected List<TestError> run (boolean fullTest) {
        ...
        ApsImportDataSet dataSet1 = new ApsImportUpdateDataSet1 (scenario, sysItm, sysBas, apsSce, apsTmp).doPreRun ();
        // ApsImportDataSet dataSet2 = new ApsImportUpdateDataSet1 (scenario, sysItm, sysBas, apsSce, apsTmp).doPreRun ();
