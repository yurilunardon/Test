...
public class AngItmVrnTmp extends AGenericTmp<AngItmVrn, ApsTmpStore, ApsTmpStoreDeletion, ApsImportContext> {
    ...
    public AngItmVrn getDummy (ApsImportContext ctx) throws SException {
        ...
        if (dummy == null ) {
            ...
            AngItmVrn removingDummy = deletionStore.removeAngItmVrn (getCode (tmpDummy));
            dummy = removingDummy == null ? AngItmVrnDao.get ().insert (tmpDummy, false, context, wCon) : removingDummy;
