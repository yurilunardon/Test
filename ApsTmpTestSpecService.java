...
public final class ApsTmpTestSpecService {
    ...
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response insertApsShpOrd (@Context UriInfo uriInfo, ApiInput<ApsShpOrd> input, @SynergyRestContext() ExecutionContext context) {
        return this.insert ((rCon, wrCon) -> ApsTmpTestLogic.get ().insertApsShpOrd (input.entity, context, rCon, wrCon), context);
    } // insertApsShpOrd
    ...
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response updateApsShpOrd (@Context UriInfo uriInfo, ApiInput<ApsShpOrd> input, @SynergyRestContext() ExecutionContext context) {
        return this.update ((rCon, wrCon) -> ApsTmpTestLogic.get ().updateApsShpOrd (input.entity, context, rCon, wrCon), context);
    } // updateApsShpOrd

    @Path ("/ApsShpOrd/check")
    @POST
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response checkApsShpOrd (@Context UriInfo uriInfo, ApiInput<FctEqualsInput<ApsShpOrd>> input, @SynergyRestContext() ExecutionContext context) {
        return this.check ((rCon) -> ApsTmpTestLogic.get ().checkApsShpOrd (input.entity, context, rCon), context);
    } // checkApsShpOrd
    ...
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response insertApsItmCop (@Context UriInfo uriInfo, ApiInput<ApsItmCop> input, @SynergyRestContext() ExecutionContext context) {
        return this.insert ((rCon, wrCon) -> ApsTmpTestLogic.get ().insertApsItmCop (input.entity, context, rCon, wrCon), context);
    } // insertApsItmCop
    ...
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response updateApsItmCop (@Context UriInfo uriInfo, ApiInput<ApsItmCop> input, @SynergyRestContext() ExecutionContext context) {
        return this.update ((rCon, wrCon) -> ApsTmpTestLogic.get ().updateApsItmCop (input.entity, context, rCon, wrCon), context);
    } // updateApsItmCop

    @Path ("/ApsItmCop/check")
    @POST
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response checkApsItmCop (@Context UriInfo uriInfo, ApiInput<FctEqualsInput<ApsItmCop>> input, @SynergyRestContext() ExecutionContext context) {
        return this.check ((rCon) -> ApsTmpTestLogic.get ().checkApsItmCop (input.entity, context, rCon), context);
    } // checkApsItmCop
    ...
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response insertApsOpr (@Context UriInfo uriInfo, ApiInput<ApsOpr> input, @SynergyRestContext() ExecutionContext context) {
        return this.insert ((rCon, wrCon) -> ApsTmpTestLogic.get ().insertApsOpr (input.entity, context, rCon, wrCon), context);
    } // insertApsOpr
    ...
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response updateApsOpr (@Context UriInfo uriInfo, ApiInput<ApsOpr> input, @SynergyRestContext() ExecutionContext context) {
        return this.update ((rCon, wrCon) -> ApsTmpTestLogic.get ().updateApsOpr (input.entity, context, rCon, wrCon), context);
    } // updateApsOpr
    ...
    @Consumes (MediaType.APPLICATION_JSON)
    @Produces (MediaType.APPLICATION_JSON)
    public Response checkApsOpr (@Context UriInfo uriInfo, ApiInput<FctEqualsInput<ApsOpr>> input, @SynergyRestContext() ExecutionContext context) {
        return this.check ((rCon) -> ApsTmpTestLogic.get ().checkApsOpr (input.entity, context, rCon), context);
    } // checkApsOpr
